...
class RefreshTokenCommandService(
    ...
    override fun saveOrUpdate(userId: UserId, token: String): RefreshToken {
        val refreshToken = refreshTokenPersistencePort.findByUserId(userId)
    ...
    override fun rotate(userId: UserId, newToken: String): RefreshToken {
        return saveOrUpdate(userId, newToken)
    }
