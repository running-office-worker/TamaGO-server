...
INSERT INTO t_monster_group_assets (monster_group_id, asset_key, asset_name, asset_type, created_at, updated_at)
VALUES
    (@turtle_group, 'dev/monster/turtle/bg/LBG_PNG_1.png', 'LBG_PNG_1.png', 'LBG_PNG', NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/LBG_PNG_2.png', 'LBG_PNG_2.png', 'LBG_PNG', NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/LBG_PNG_3.png', 'LBG_PNG_3.png', 'LBG_PNG', NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/LBG_PNG_4.png', 'LBG_PNG_4.png', 'LBG_PNG', NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/LBG_PNG_5.png', 'LBG_PNG_5.png', 'LBG_PNG', NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/RBG_PNG_1.png', 'RBG_PNG_1.png', 'RBG_PNG', NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/RBG_PNG_2.png', 'RBG_PNG_2.png', 'RBG_PNG', NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/RBG_PNG_3.png', 'RBG_PNG_3.png', 'RBG_PNG', NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/RBG_PNG_4.png', 'RBG_PNG_4.png', 'RBG_PNG', NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/RBG_PNG_5.png', 'RBG_PNG_5.png', 'RBG_PNG', NOW(), NOW()),

    (@fire_group, 'dev/monster/fire/bg/LBG_PNG_1.png', 'LBG_PNG_1.png', 'LBG_PNG', NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/LBG_PNG_2.png', 'LBG_PNG_2.png', 'LBG_PNG', NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/LBG_PNG_3.png', 'LBG_PNG_3.png', 'LBG_PNG', NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/LBG_PNG_4.png', 'LBG_PNG_4.png', 'LBG_PNG', NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/LBG_PNG_5.png', 'LBG_PNG_5.png', 'LBG_PNG', NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/RBG_PNG_1.png', 'RBG_PNG_1.png', 'RBG_PNG', NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/RBG_PNG_2.png', 'RBG_PNG_2.png', 'RBG_PNG', NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/RBG_PNG_3.png', 'RBG_PNG_3.png', 'RBG_PNG', NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/RBG_PNG_4.png', 'RBG_PNG_4.png', 'RBG_PNG', NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/RBG_PNG_5.png', 'RBG_PNG_5.png', 'RBG_PNG', NOW(), NOW()),

    (@penguin_group, 'dev/monster/snow/bg/LBG_PNG_1.png', 'LBG_PNG_1.png', 'LBG_PNG', NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/LBG_PNG_2.png', 'LBG_PNG_2.png', 'LBG_PNG', NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/LBG_PNG_3.png', 'LBG_PNG_3.png', 'LBG_PNG', NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/LBG_PNG_4.png', 'LBG_PNG_4.png', 'LBG_PNG', NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/LBG_PNG_5.png', 'LBG_PNG_5.png', 'LBG_PNG', NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/RBG_PNG_1.png', 'RBG_PNG_1.png', 'RBG_PNG', NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/RBG_PNG_2.png', 'RBG_PNG_2.png', 'RBG_PNG', NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/RBG_PNG_3.png', 'RBG_PNG_3.png', 'RBG_PNG', NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/RBG_PNG_4.png', 'RBG_PNG_4.png', 'RBG_PNG', NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/RBG_PNG_5.png', 'RBG_PNG_5.png', 'RBG_PNG', NOW(), NOW());
