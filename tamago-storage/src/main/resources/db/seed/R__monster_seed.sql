...
VALUES
    (@turtle_group, 'dev/monster/turtle/bg/LBG_PNG_1.png', 'LBG_PNG_1.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#59774C'), NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/LBG_PNG_2.png', 'LBG_PNG_2.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#96A84F'), NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/LBG_PNG_3.png', 'LBG_PNG_3.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#7BA563'), NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/LBG_PNG_4.png', 'LBG_PNG_4.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#908440'), NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/LBG_PNG_5.png', 'LBG_PNG_5.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#273D57'), NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/RBG_PNG_1.png', 'RBG_PNG_1.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#59774C'), NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/RBG_PNG_2.png', 'RBG_PNG_2.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#96A84F'), NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/RBG_PNG_3.png', 'RBG_PNG_3.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#7BA563'), NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/RBG_PNG_4.png', 'RBG_PNG_4.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#908440'), NOW(), NOW()),
    (@turtle_group, 'dev/monster/turtle/bg/RBG_PNG_5.png', 'RBG_PNG_5.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#273D57'), NOW(), NOW()),

    (@fire_group, 'dev/monster/fire/bg/LBG_PNG_1.png', 'LBG_PNG_1.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#6B6A6F'), NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/LBG_PNG_2.png', 'LBG_PNG_2.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#070C1F'), NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/LBG_PNG_3.png', 'LBG_PNG_3.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#171929'), NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/LBG_PNG_4.png', 'LBG_PNG_4.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#202434'), NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/LBG_PNG_5.png', 'LBG_PNG_5.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#000000'), NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/RBG_PNG_1.png', 'RBG_PNG_1.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#6B6A6F'), NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/RBG_PNG_2.png', 'RBG_PNG_2.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#070C1F'), NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/RBG_PNG_3.png', 'RBG_PNG_3.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#171929'), NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/RBG_PNG_4.png', 'RBG_PNG_4.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#202434'), NOW(), NOW()),
    (@fire_group, 'dev/monster/fire/bg/RBG_PNG_5.png', 'RBG_PNG_5.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#000000'), NOW(), NOW()),

    (@penguin_group, 'dev/monster/snow/bg/LBG_PNG_1.png', 'LBG_PNG_1.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#DAE8F9'), NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/LBG_PNG_2.png', 'LBG_PNG_2.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#ACB8EC'), NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/LBG_PNG_3.png', 'LBG_PNG_3.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#9BA6E9'), NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/LBG_PNG_4.png', 'LBG_PNG_4.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#061851'), NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/LBG_PNG_5.png', 'LBG_PNG_5.png', 'LBG_PNG', JSON_OBJECT('backgroundColor', '#7789E0'), NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/RBG_PNG_1.png', 'RBG_PNG_1.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#DAE8F9'), NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/RBG_PNG_2.png', 'RBG_PNG_2.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#ACB8EC'), NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/RBG_PNG_3.png', 'RBG_PNG_3.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#9BA6E9'), NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/RBG_PNG_4.png', 'RBG_PNG_4.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#061851'), NOW(), NOW()),
    (@penguin_group, 'dev/monster/snow/bg/RBG_PNG_5.png', 'RBG_PNG_5.png', 'RBG_PNG', JSON_OBJECT('backgroundColor', '#7789E0'), NOW(), NOW());
